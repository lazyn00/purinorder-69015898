        ...
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">1. Chính sách đặt hàng</CardTitle>
            </CardHeader>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">2. Chính sách thanh toán</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              <ul className="list-disc list-inside space-y-2">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">3. Chính sách vận chuyển</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              <ul className="list-disc list-inside space-y-2">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">4. Chính sách đổi trả</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              <ul className="list-disc list-inside space-y-2">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">5. Chính sách Hoàn tiền</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              <ul className="list-disc list-inside space-y-2">
                <li>
              ...
              <p className="mt-4">
                <span className="font-medium text-foreground">Lưu ý:</span> Không hoàn tiền vì khác hình, lỗi xưởng, hoặc đổi ý.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">6. Chính sách bảo mật thông tin</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              <ul className="list-disc list-inside space-y-2">
