      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="relative">
                ...
                <CarouselContent>
                    ...
                    <CarouselItem key={index}>
                        {/* aspect-square: Tạo khung vuông 1:1 
                            flex items-center justify-center: Căn giữa nội dung bên trong
                        */}
                        <div className="relative overflow-hidden rounded-xl border flex items-center justify-center bg-muted/10 aspect-square w-full">
                            <img
                                src={image}
                                alt={`${product.name} - ${index + 1}`}
                                // object-contain: Ảnh giữ nguyên tỷ lệ gốc, nằm lọt trong khung
                ...
                {/* --- SỐ TRANG (INDICATOR STYLE SHOPEE) --- */}
                {count > 0 && (
          ...
          <div className="space-y-6">
            ...
            {/* --- PHÂN LOẠI (Vẫn dùng Dropdown Select theo yêu cầu) --- */}
